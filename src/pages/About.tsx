    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1">
        ...
        <section className="relative h-[500px] flex items-center justify-center overflow-hidden">
          <div className="absolute inset-0 bg-gradient-to-r from-primary/90 to-accent-dark/90 mix-blend-multiply" />
          <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1524178232363-1fb2b075b655?w=1200')] bg-cover bg-center bg-fixed" />
          <div className="relative z-10 text-center px-4">
            <h1 className="text-4xl md:text-6xl font-bold mb-8 text-white animate-fade-in">
              Façonnons ensemble
              <span className="block mt-2">l'avenir de l'éducation</span>
            </h1>
            <p className="text-xl text-white/90 leading-relaxed mb-8 max-w-3xl mx-auto animate-fade-in">
