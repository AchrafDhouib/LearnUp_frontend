...
const Register = () => {
  ...
  const onSubmit = async (data: FormValues) => {
    ...
    try {
      ...
      const success = await register(userData, 'student');
          ...
          <Card>
            <CardHeader className="space-y-1">
              ...
              <CardDescription className="text-center">
                Créez votre compte pour accéder à des milliers de cours
              </CardDescription>
            </CardHeader>
            <CardContent>
              <Form {...form}>
            ...
            <CardFooter className="flex flex-col space-y-2">
              ...
              <div className="text-sm text-gray-500 text-center">
                Vous êtes enseignant? <Link to="/teacher/register" className="text-primary hover:underline">Créer un compte enseignant</Link>
              </div>
            </CardFooter>
          </Card>
        </div>
